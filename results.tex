...
However, the impact of applying best generated sequences using NS clearly outperform O2 and O3 with almost 10\% of CPU improvement and 7\% of memory improvement. This proves that NS sequences are efficient and can be used to optimize resource consumption of new Csmith programs. This result also proves that Csmith code generator applies the same rules and structures to generate C code. That is why, the best optimization sequences have always a positive impact on the non-functional properties.
