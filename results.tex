...
%For RQ1, experiments take about 21 days. These optimization
%times might seem long. However, it should be noted that
%these tests have to be performed once off-line, while the
%results (optimization sequences) can be re-used without additional
%overhead for a large number of devices. Therefore, the
%high performance requirements imposed on today’s systems
%fully justify the observed optimization times.
