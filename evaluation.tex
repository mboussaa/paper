...
The goal of this experiment is to put more emphasis on resource consumption and use GENECO to find trade-offs between non-functional properties of generated code like $<$ExecutionTime--MemoryUsage$>$ , etc.
...
\begin{table}[]
	...
	\begin{tabular}{|l|l|l|l|l|l|l|c|}
		\hline
		\multirow{2}{*}{} & \multicolumn{7}{l|}{Average Performance Improvement (\%)} \\ \cline{2-8} 
		& \multicolumn{1}{c|}{O1} & \multicolumn{1}{c|}{O2} & \multicolumn{1}{c|}{O3} & \multicolumn{1}{c|}{Ofast} & \multicolumn{1}{c|}{RS} & \multicolumn{1}{c|}{GA} & NS \\ \hline
		Execution Speedup &  &  &  &  &  &  &  \\ \hline
		Memory &  &  &  &  &  &  &  \\ \hline
		CPU &  &  &  &  &  &  &  \\ \hline
		Compilation Speedup &  &  &  &  &  &  &  \\ \hline
		Code Size &  &  &  &  &  &  &  \\ \hline
	\end{tabular}
\end{table}
