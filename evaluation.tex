...
-\textit{Speedup (S)}: corresponds to the percentage improvement in execution speed of an optimized code compared to the execution time of the baseline version. Programs execution time is measured in seconds.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\linewidth]{Ressources/infraup.png}
