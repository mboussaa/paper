...
For functional testing of compilers, software testers generally use to run a set of test suites on different optimized software versions and compare the functional outcome that can be either pass (correct behaviour) or fail (incorrect behaviour, crashes or bugs)~\cite{chen2016empirical,hoste2008cole,le2014compiler}.
...
\begin{itemize}  
	...
	\item The paper introduces a novel formulation of the compiler optimization problem using Novelty Search~\cite{lehman2008exploiting}. We evaluate the effectiveness of our approach by verifying the optimizations performed by GCC compiler.
