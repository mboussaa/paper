...
NOTICE rely on Linux containers to offer facilities to compiler users to test non-functional properties of generated code. We resume, in the following, the main advantages of this approach:
\begin{enumerate}
